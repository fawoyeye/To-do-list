...
switch(day){
			...
			switch(currentHour){
							case 21: case 22: case 24: case 23: case 1: case 2: case 3: case 4: case 5: time.innerHTML =`It's ${add}, You are awake working? Welldone ${name}`;
		break;
		case 6: case 7: case 8: case 9: case 10: case 11: case 12: time.innerHTML =`It's ${add}, Good morning Hard worker!`;
		break;
		case 13: case 14: case 15: case 16: time.innerHTML =`It's ${add}, Good afternoon ${name}`;
		break;
case 17: case 18: case 19: case 20: time.innerHTML =`It's ${add}, Good Evening ${name}`;
		break;
